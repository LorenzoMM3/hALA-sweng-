  ...
  private void cellListStyleInitializer() {
    cellListStyle = new com.google.gwt.user.cellview.client.CellList.Style() {
      ...
      public String getText() {
        return (".com-google-gwt-user-cellview-client-CellList-Style-cellListEvenItem, .com-google-gwt-user-cellview-client-CellList-Style-cellListOddItem {\n  cursor : " + ("pointer")  + ";\n  zoom : " + ("1")  + ";\n}\n.com-google-gwt-user-cellview-client-CellList-Style-cellListKeyboardSelectedItem {\n  background : " + ("#ffc")  + ";\n}\n.com-google-gwt-user-cellview-client-CellList-Style-cellListSelectedItem {\n  height : " + ((CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getHeight() + "px")  + ";\n  overflow : " + ("hidden")  + ";\n  background : " + ("url(\"" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getSafeUri().asString() + "\") -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getLeft() + "px -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getTop() + "px  repeat-x")  + ";\n  background-color : " + ("#628cd5")  + ";\n  color : " + ("white")  + ";\n  height : " + ("auto")  + ";\n  overflow : " + ("visible")  + ";\n}\n");
      }
      public java.lang.String cellListEvenItem() {
        return "com-google-gwt-user-cellview-client-CellList-Style-cellListEvenItem";
      }
      public java.lang.String cellListKeyboardSelectedItem() {
        return "com-google-gwt-user-cellview-client-CellList-Style-cellListKeyboardSelectedItem";
      }
      public java.lang.String cellListOddItem() {
        return "com-google-gwt-user-cellview-client-CellList-Style-cellListOddItem";
      }
      public java.lang.String cellListSelectedItem() {
        return "com-google-gwt-user-cellview-client-CellList-Style-cellListSelectedItem";
      }
      public java.lang.String cellListWidget() {
        return "com-google-gwt-user-cellview-client-CellList-Style-cellListWidget";
      }
    }
    ;
  }
