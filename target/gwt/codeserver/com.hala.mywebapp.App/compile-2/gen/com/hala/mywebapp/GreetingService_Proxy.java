...
public class GreetingService_Proxy extends RemoteServiceProxy implements com.hala.mywebapp.GreetingServiceAsync {
  ...
  private static final String SERIALIZATION_POLICY ="45AB576A91002C666AACF4862C82B902";
  ...
  public void aggiungiScenarioAScelta(com.hala.mywebapp.Scenario scenario, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    ...
    try {
      ...
      streamWriter.writeString("com.hala.mywebapp.Scenario/982495959");
  ...
  public void salvaSuFileScenari(java.lang.String nomeStoria, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("GreetingService_Proxy", "salvaSuFileScenari");
    try {
      SerializationStreamWriter streamWriter = helper.start(REMOTE_SERVICE_INTERFACE_NAME, 1);
      streamWriter.writeString("java.lang.String/2004016611");
  ...
  public void settaCollegamentoSuccessivo(com.hala.mywebapp.Scenario scenario, com.hala.mywebapp.Scenario collegamento, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("GreetingService_Proxy", "settaCollegamentoSuccessivo");
    try {
      SerializationStreamWriter streamWriter = helper.start(REMOTE_SERVICE_INTERFACE_NAME, 2);
      streamWriter.writeString("com.hala.mywebapp.Scenario/982495959");
      streamWriter.writeString("com.hala.mywebapp.Scenario/982495959");
      streamWriter.writeObject(scenario);
      streamWriter.writeObject(collegamento);
      helper.finish(callback, ResponseReader.BOOLEAN);
    } catch (SerializationException ex) {
      callback.onFailure(ex);
    }
  ...
  public void settaScenarioIniziale(com.hala.mywebapp.Scenario scenario, com.google.gwt.user.client.rpc.AsyncCallback callback) {
