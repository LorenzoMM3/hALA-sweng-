// .ui.xml template last modified: 1709217685863
...
public class Starter_StarterUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.hala.mywebapp.Starter>, com.hala.mywebapp.Starter.StarterUiBinder {
  ...
  class Widgets {
     ...
     */
    private com.hala.mywebapp.Starter_StarterUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.hala.mywebapp.Starter_StarterUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.hala.mywebapp.Starter_StarterUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
