// .ui.xml template last modified: 1709376519310
...
public class Collegamenti_CollegamentiUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.hala.mywebapp.Collegamenti>, com.hala.mywebapp.Collegamenti.CollegamentiUiBinder {
  ...
  class Widgets {
     ...
     */
    private com.hala.mywebapp.Collegamenti_CollegamentiUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.hala.mywebapp.Collegamenti_CollegamentiUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.hala.mywebapp.Collegamenti_CollegamentiUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.ListBox build_menuScenari() {
      ...
      menuScenari.addItem("Scenario con oggetto");
    ...
    private com.google.gwt.user.client.ui.ListBox build_menuAltriScenari() {
      ...
      menuAltriScenari.addItem("Scenario con oggetto");
    ...
    private com.google.gwt.user.client.ui.ListBox build_nodo2() {
      ...
      nodo2.addItem("Scenario con oggetto");
