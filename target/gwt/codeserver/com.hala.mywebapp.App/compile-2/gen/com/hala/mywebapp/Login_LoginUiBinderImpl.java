// .ui.xml template last modified: 1709625500692
...
public class Login_LoginUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.Widget, com.hala.mywebapp.Login>, com.hala.mywebapp.Login.LoginUiBinder {
  ...
  public com.google.gwt.user.client.ui.Widget createAndBindUi(final com.hala.mywebapp.Login owner) {
   ...
   */
  class Widgets {
    private final com.hala.mywebapp.Login owner;


    public Widgets(final com.hala.mywebapp.Login owner) {
      this.owner = owner;
     ...
     */
    private com.hala.mywebapp.Login_LoginUiBinderImpl_GenBundle get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      return build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay();
    }
    private com.hala.mywebapp.Login_LoginUiBinderImpl_GenBundle build_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay() {
      // Creation section.
      final com.hala.mywebapp.Login_LoginUiBinderImpl_GenBundle clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay = (com.hala.mywebapp.Login_LoginUiBinderImpl_GenBundle) GWT.create(com.hala.mywebapp.Login_LoginUiBinderImpl_GenBundle.class);
      // Setup section.
     ...
     */
    private com.hala.mywebapp.Login_LoginUiBinderImpl_GenCss_style get_style() {
      return build_style();
    }
    private com.hala.mywebapp.Login_LoginUiBinderImpl_GenCss_style build_style() {
      // Creation section.
      final com.hala.mywebapp.Login_LoginUiBinderImpl_GenCss_style style = get_clientBundleFieldNameUnlikelyToCollideWithUserSpecifiedFieldOkay().style();
      // Setup section.
    ...
    private com.google.gwt.user.client.ui.VerticalPanel build_f_VerticalPanel1() {
      ...
      f_VerticalPanel1.add(get_loginButton());
    ...
    private com.google.gwt.user.client.ui.Button build_loginButton() {
      ...
      // Setup section.
      loginButton.setHTML(template_html1().asString());
      loginButton.setStyleName("" + get_style().Login() + "");
